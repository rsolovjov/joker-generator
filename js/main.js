(function ($) {
    $(document).ready(function () {
		...
		preview_for_client_validation = function()
		{
			...
			log.cards_on_table = $('#table').data('generator').parseCards($('#onTable li'), false);
			log.hand = $('#table').data('generator').parseCards($('#myCards li'), false);
			
			log.answer = {};
			log.answer.valid_cards = $('#table').data('generator').parseCards($('#myCards li'), true);
		...
		{
			var cards_on_table = $('#table').data('generator').parseCards($('#onTable li'), false);
			var first_player = 1;
		...
		{
			var cards_on_table = $('#table').data('generator').parseCards($('#onTable li'), false);
			var hand = $('#table').data('generator').parseCards($('#myCards li'), false);
			var valid_cards = $('#table').data('generator').parseCards($('#myCards li'), true);
